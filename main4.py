...
def translate_word_file(file_path):
    ...
    for para in doc.paragraphs:
        if para.text.strip():  # Skip empty paragraphs
            ...
            # Copy the Hindi paragraph first, followed by its English translation
            ...
            for i, cell in enumerate(row.cells):
                if cell.text.strip():  # Skip empty cells
                    if is_number(cell.text):
                        ...
                        # Translate and add both Hindi and English content in order
