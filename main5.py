## This code keeps the translated hindi language at the top, the puts the english
## It tries to keep the same formatting of the english. But the hindi formatting cannot be kept the same as the english as there are fonts issues,
...
def copy_paragraph_with_formatting(source_para, target_doc, translated_text=None):
    ...
    # Add the English paragraph directly after
...
def translate_word_file(file_path):
    ...
    for para in doc.paragraphs:
        if para.text.strip():  # Skip empty paragraphs
            ...
            # Add the Hindi and English paragraphs (no extra space between)
